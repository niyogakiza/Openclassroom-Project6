...
const message1 =  prompt('Enter the name of the first player');
const message2 = prompt('Enter  the name of the second player');
    ...
    $(document).keydown(event =>{
        if (event.which === 37) {
            ...
            if (warriorTurn) { // warrior 2 turn
                $('#warrior1Div').fadeTo(500);
                $('#warrior2Div').fadeTo(500);
                ...
                $('#warriorDiv2').fadeTo(500);
                $('#warriorDiv1').fadeTo(500);
...
function fightDescription(loser, attacker){
    if (loser.colIdWarrior === attacker.colIdWarrior - 1 && (attacker.colIdWarrior - 1)
        ...
        % columNum !== 0 || loser.colIdWarrior === attacker.colIdWarrior - columNum || loser.colIdWarrior === attacker.colIdWarrior + columNum && !attacker.guard) {
...
/*===== End of fight and back to replay or non playing again =========*/
function endOfFight(player){
    if(player.life <= 0){
        player.warriorInfo();
        alert(`${player.name}, You lost the fight !!!!`);
